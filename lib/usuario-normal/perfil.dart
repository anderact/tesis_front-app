      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              // vectorADr (52:1061)
              margin: EdgeInsets.fromLTRB(26*fem, 0*fem, 0*fem, 36.29*fem),
              width: 12.24*fem,
              height: 4.71*fem,
              child: Image.asset(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(28*fem, 0*fem, 17*fem, 37*fem),
              width: double.infinity,
              height: 56*fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                              ...
                              child: Container(
                                decoration: BoxDecoration (
                                  ...
                                  gradient: const LinearGradient (
                                    ...
                                    colors: <Color>[Color(0x4cf50e0e), Color(0x4cfa2c2c), Color(0x4cefefef)],
                                    stops: <double>[0, 0, 1],
                                  ),
                                ),
                              ),
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(14*fem, 11*fem, 0*fem, 15*fem),
                    height: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration (
                              ...
                              gradient: const LinearGradient (
                                ...
                                colors: <Color>[Color(0xfff50e0e), Color(0xfffa2c2c), Color(0xffefefef)],
                                stops: <double>[0, 0, 1],
                              ),
                            ),
                            child: Center(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(28*fem, 0*fem, 17*fem, 46*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(20*fem, 19.89*fem, 20.38*fem, 76.31*fem),
                    width: double.infinity,
                    decoration: BoxDecoration (
                      color: const Color(0xffffffff),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(4.01*fem, 0*fem, 0*fem, 15.57*fem),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                // iconprofile2Mr (25:1106)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 14.04*fem, 0.07*fem),
                                width: 11.95*fem,
                                height: 15.26*fem,
                                child: Image.asset(
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 134.38*fem, 0*fem),
                                child: Text(
                                  'Datos Personales',
                                  style: SafeGoogleFont (
                                    'Poppins',
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(1.92*fem, 0*fem, 0*fem, 0*fem),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Container(
                                // iconactivity5jS (25:1131)
                                margin: EdgeInsets.fromLTRB(0*fem, 1.99*fem, 11.92*fem, 0*fem),
                                width: 16.16*fem,
                                height: 16.45*fem,
                                child: Image.asset(
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 0.25*fem, 112.38*fem, 0*fem),
                                child: Text(
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(20*fem, 20*fem, 15*fem, 21*fem),
                    width: double.infinity,
                    decoration: BoxDecoration (
                      color: const Color(0xffffffff),
                      borderRadius: BorderRadius.circular(16*fem),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(2.92*fem, 0*fem, 0*fem, 0*fem),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                // iconnotif8je (25:1144)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 12.92*fem, 0*fem),
                                width: 14.17*fem,
                                height: 16.67*fem,
                                child: Image.asset(
                  ...
                  Container(
                    // bgEw6 (25:1147)
                    padding: EdgeInsets.fromLTRB(20*fem, 20*fem, 21.38*fem, 21*fem),
                    width: double.infinity,
                    decoration: BoxDecoration (
                      color: const Color(0xffffffff),
                      borderRadius: BorderRadius.circular(16*fem),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(1.67*fem, 0*fem, 0*fem, 12*fem),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 159.38*fem, 0*fem),
                                child: Text(
                                  'Contáctanos',
                                  style: SafeGoogleFont (
                                    'Poppins',
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(3.54*fem, 0*fem, 0*fem, 12*fem),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                // iconprivacyeWx (25:1170)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 13.57*fem, 1.7*fem),
                                width: 12.89*fem,
                                height: 15.71*fem,
                                child: Image.asset(
                        ...
                        Container(
                          // settingDCg (25:1158)
                          margin: EdgeInsets.fromLTRB(2.73*fem, 0*fem, 0*fem, 0*fem),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                // iconsettingweU (25:1163)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 12.45*fem, 0.18*fem),
                                width: 14.82*fem,
                                height: 16.02*fem,
                                child: Image.asset(
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 152.38*fem, 0*fem),
                                child: Text(
                                  'Configuración',
                                  style: SafeGoogleFont (
                                    'Poppins',
