        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Center(
                      ...
                      child: SizedBox(
                        ...
                        height: 10*fem,
                        child: Image.asset(
                          'assets/usuario-normal/images/pm-Mp8.png',
                          width: 46*fem,
                          height: 10*fem,
                        ),
                      ),
                  ...
                  Container(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/usuario-normal/images/alarm-Wf6.png',
                      width: 15*fem,
                      height: 15*fem,
                    ),
                  ),
                  Container(
                    ...
                    height: 14*fem,
                    child: Image.asset(
                      'assets/usuario-normal/images/bluetooth-MAL.png',
                      width: 10*fem,
                      height: 14*fem,
                    ),
                  ),
                  Container(
                    ...
                    height: 11.25*fem,
                    child: Image.asset(
                      'assets/usuario-normal/images/wifi-9cp.png',
                      width: 15.42*fem,
                      height: 11.25*fem,
                    ),
                  ),
                  Container(
                    ...
                    height: 11.8*fem,
                    child: Image.asset(
                      'assets/usuario-normal/images/signal-C68.png',
                      width: 11.8*fem,
                      height: 11.8*fem,
                    ),
                  ),
                  Container(
                    ...
                    height: 10.5*fem,
                    child: Image.asset(
                      'assets/usuario-normal/images/battery-1nU.png',
                      width: 15*fem,
                      height: 10.5*fem,
                    ),
                  ),
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(36*fem, 0*fem, 37*fem, 26*fem),
              width: double.infinity,
              height: 36*fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(8*fem, 4*fem, 170*fem, 4*fem),
                    height: double.infinity,
                    decoration: BoxDecoration (
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 122*fem, 12*fem),
              width: 172*fem,
              height: 50*fem,
              child: Stack(
                children: [
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(35*fem, 0*fem, 0*fem, 30.5*fem),
              height: 116.5*fem,
              decoration: BoxDecoration (
                borderRadius: BorderRadius.circular(40.5*fem),
              ),
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 12*fem, 0.5*fem),
                    width: 83*fem,
                    height: 116*fem,
                    decoration: BoxDecoration (
                      borderRadius: BorderRadius.circular(40.5*fem),
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 11*fem, 0.5*fem),
                          width: 83*fem,
                          height: 116*fem,
                          decoration: BoxDecoration (
                            borderRadius: BorderRadius.circular(40.5*fem),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(9.2*fem, 14.4*fem, 9.2*fem, 12*fem),
                    width: 37.6*fem,
                    height: double.infinity,
                    decoration: BoxDecoration (
